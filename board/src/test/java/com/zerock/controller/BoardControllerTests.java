...
@WebAppConfiguration
@ContextConfiguration(classes = {com.zerock.config.RootConfig.class, com.zerock.config.ServletConfig.class})
@Log4j
public class BoardControllerTests {
	...
	public void testListPaging() throws Exception{
		log.info(mockMvc.perform(MockMvcRequestBuilders.get("/board/list").param("pageNum", "1").param("amount", "5")).andReturn().getModelAndView().getModelMap());
	}
}
